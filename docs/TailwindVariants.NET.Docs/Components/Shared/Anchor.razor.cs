...
public partial class Anchor : ISlotted<Anchor.Slots>
{
	private static readonly TvDescriptor<Anchor, Slots> _anchor = new
	(
	...
	protected override TvDescriptor<Anchor, Slots> GetDescriptor() => _anchor;
