...
public partial class SlotsAccessorGenerator
{
	...
	private static void WriteEnum(Indenter sb, SlotInfo accessor)
	{
		sb.AppendLine();
	...
	private static void WriteExtensions(Indenter sb, SlotInfo accessor)
	{
	...
	private static void WriteISlotsClass(Indenter sb, SlotInfo accessor)
	{
	...
	private static void WriteNamesHelper(Indenter sb, SlotInfo accessor)
	{
	...
	private static void WriteNestedClosings(Indenter sb, SlotInfo accessor)
	{
	...
	private static void WriteNestedOpenings(Indenter sb, SlotInfo accessor)
	{
		ImmutableArray<string> hierarchy = accessor.Hierarchy;
	...
	private static void WritePreamble(Indenter sb, SlotInfo accessor)
	{
